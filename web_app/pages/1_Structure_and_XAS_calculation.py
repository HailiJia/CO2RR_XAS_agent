# web_app/pages/1_Structure_and_XAS_calculation.py
...
PAGE_TAG = "v2_2026-07-06_structure_xas_calculation_nersc_workflow"

st.set_page_config(page_title="CO2RR XAS Agent | Structure and XAS calculation", layout="wide")
st.title("Structure and XAS calculation")
